...
y$Q1[y$Q1=="Don’t know"] <- NA
y$Q1[y$Q1=="Refused"] <- NA
table(y$Q1)
...
y$Q3[y$Q3=="Don’t know"] <- NA
y$Q3[y$Q3=="Refused"] <- NA
table(y$Q3)
...
y$Q4[y$Q4=="Don’t know"] <- NA
y$Q4[y$Q4=="Refused"] <- NA
table(y$Q4)
y$Q4 <- as.numeric(y$Q4)

table(y$Q6)
y$Q6[y$Q6=="Better off"] <- 1
y$Q6[y$Q6=="Worse off"] <- 3
y$Q6[y$Q6=="Same (Volunteered)"] <- 2
y$Q6[y$Q6=="Don’t know"] <- NA
y$Q6[y$Q6=="Refused"] <- NA
table(y$Q6)
...
y$Q12A[y$Q12A=="Don’t know"] <- NA
y$Q12A[y$Q12A=="Refused"] <- NA
...
y$Q12B[y$Q12B=="Don’t know"] <- NA
y$Q12B[y$Q12B=="Refused"] <- NA
...
y$Q12C[y$Q12C=="Don’t know"] <- NA
y$Q12C[y$Q12C=="Refused"] <- NA
...
y$Q12D[y$Q12D=="Don’t know"] <- NA
y$Q12D[y$Q12D=="Refused"] <- NA
...
y$Q13A[y$Q13A=="Don't know"] <- NA
y$Q13A[y$Q13A=="Refused"] <- NA
table(y$Q13A)
...
y$Q13B[y$Q13B=="Don't know"] <- NA
y$Q13B[y$Q13B=="Refused"] <- NA
table(y$Q13B)
...
y$Q13E[y$Q13E=="Don't know"] <- NA
y$Q13E[y$Q13E=="Refused"] <- NA
table(y$Q13E)
...
y$Q13F[y$Q13F=="Don't know"] <- NA
y$Q13F[y$Q13F=="Refused"] <- NA
table(y$Q13F)
...
y$Q13G[y$Q13G=="Don't know"] <- NA
y$Q13G[y$Q13G=="Refused"] <- NA
table(y$Q13G)
...
y$Q17[y$Q17=="Don’t know"] <- NA
y$Q17[y$Q17=="Refused"] <- NA
table(y$Q17)
...
y$Q18[y$Q18=="Don’t know"] <- NA
y$Q18[y$Q18=="Refused"] <- NA
table(y$Q18)
...
y$Q19B[y$Q19B=="Don't know"] <- NA
y$Q19B[y$Q19B=="Refused"] <- NA
table(y$Q19B)
...
for (i in 18:19){
  ...
  y[,i] <- gsub("Don’t know", NA, y[,i])
  y[,i] <- gsub("Refused", NA, y[,i])
  y[,i] <- as.numeric(y[,i])
}

for (i in 20:26){
  y[,i] <- gsub("Approve", 1, y[,i])
  y[,i] <- gsub("Disapprove", 2, y[,i])
  y[,i] <- gsub("Don't know", NA, y[,i])
  y[,i] <- gsub("Refused", NA, y[,i])
  y[,i] <- as.numeric(y[,i])
}
...
y$Q32[y$Q32=="Don't know"] <- NA
y$Q32[y$Q32=="Refused"] <- NA
table(y$Q32)
...
y$Q33[y$Q33=="Don't know"] <- NA
y$Q33[y$Q33=="Refused"] <- NA
table(y$Q33)
...
y$Q39[y$Q39=="Don't know"] <- NA
y$Q39[y$Q39=="Refused"] <- NA
table(y$Q39)
...
y$Q40[y$Q40=="Don't know"] <- NA
y$Q40[y$Q40=="Refused"] <- NA
table(y$Q40)
...
y$Q41[y$Q41=="Don't know"] <- NA
y$Q41[y$Q41=="Refused"] <- NA
table(y$Q41)
...
y$Q42[y$Q42=="Don't know"] <- NA
y$Q42[y$Q42=="Refused"] <- NA
table(y$Q42)
...
y$Q43[y$Q43=="Don't know"] <- NA
y$Q43[y$Q43=="Refused"] <- NA
table(y$Q43)
...
y$Q44[y$Q44=="Climate change does not exist (Volunteered)"] <- 4
y$Q44[y$Q44=="Don't know"] <- NA
y$Q44[y$Q44=="Refused"] <- NA
table(y$Q44)
...
y$Q70[y$Q70=="Yes"] <- 1
y$Q70[y$Q70=="No"] <- 2
y$Q70[y$Q70=="Don’t know"] <- NA
y$Q70[y$Q70=="Refused"] <- NA
table(y$Q70)
y$Q70 <- as.numeric(y$Q70)

y$Q71[y$Q71=="Yes"] <- 1
y$Q71[y$Q71=="No"] <- 2
y$Q71[y$Q71=="Don’t know"] <- NA
y$Q71[y$Q71=="Refused"] <- NA
table(y$Q71)
...
y$Q152[y$Q152=="Don't know"] <- NA
y$Q152[y$Q152=="Refused"] <- NA
table(y$Q152)
...
y$Q164[y$Q164=="Don’t know"] <- NA
y$Q164[y$Q164=="Refused"] <- NA
table(y$Q164)
y$Q164 <- as.numeric(y$Q164)

# We're throwing out all the missing data instead of trying to impute or code at 99
