...
After much discussion with our stats professor, my partner and I settled on not using the survey weights and using country means to present the data at the country level. Not the original plan - I had the weights syntax ready to go - but our professor told us to skip all that and just focus on the multivariate analysis part of the project.
